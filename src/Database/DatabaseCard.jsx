...
const DatabaseCard = ({data}) => {
    const{name,image,profession,email,roll,sscbatch,fbUrl,phone,linkedinUrl}=data;
	...
	<div className="container">
		<table className="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden  sm:shadow my-1">
            ...
            <tr className="flex flex-col  flex-no wrap sm:table-row mb-2 sm:mb-0">
                  ...
                  <img className="w-10 h-10 rounded-full" src={image} alt="User Data"/>
					...
					<td className="border-grey-light border flex gap-2 text-lg flex-row   p-3 truncate">   <FacebookShareButton
          url={shareUrl}
          className="mt-2"
        >
        ...
        >
          <LinkedinIcon size={26} round />
					...
					<td className="border-grey-light border md:w-[100px] hover   p-3 truncate"> <IoArrowForwardCircle  className="md:ml-6 text-[27px] text-blue-950 "></IoArrowForwardCircle> </td>
