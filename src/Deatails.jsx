...
const Deatails = () => {
    ...
    const {
        _id,name,title,status,authorImg,img,date,description
...
<div  className="lg:w-[100%]  mx-auto flex flex-wrap">
  <img alt="ecommerce"  className="lg:w-1/2 md:w-[600px] md:h-[600px] sm:w-[800px] mt-8 object-cover object-center rounded border border-gray-200" src={img}/>
  <div  className="lg:w-1/2 w-full lg:pl-10 md:pl-10 pl-3 pr-3 lg:py-6 mt-6 lg:mt-0">
    <h2  className="text-base title-font font-semibold text-gray-500 tracking-widest">{title}</h2>
    ...
    <div className=" flex gap-3 items-center font-semibold text-gray-800  hover:bg-gray-100 rounded-md hover:cursor-pointer">
        ...
        <div>
            <img className="w-14 h-14 rounded-full" src={authorImg} alt="Rebecca Burke"/>
          </div>
        <h1  className="text-gray-900 mt-2 text-3xl title-font font-medium mb-1">{name}</h1>
    ...
    <div className='flex'>
     ...
     <Link to={'/'}>
     <button   className="flex ml-auto text-white  bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded"> <FaAnglesLeft className='mt-1   text-xl' /> <span className="ml-2">Back to home</span> </button>
