...
const EventsCard = ({events}) => {
    ...
    return (
        <div data-aos='fade-up' className=" flex  h-[510px] max-w-[26rem]  flex-col rounded-xl bg-gray-100 bg-clip-border text-gray-700 shadow-lg">
  ...
  <div className="p-6">
    ...
    <div className=" flex gap-3 mt-2 items-center font-semibold text-gray-800  hover:bg-gray-100 rounded-md hover:cursor-pointer">
            <img className="w-9 h-9 rounded-full" src={authorImg} alt="Rebecca Burke"/>
    ...
    <Link > <button className='btn w-full text-white btn-warning bg-red-500  mt-6 '>Read More</button></Link>
  </div>
